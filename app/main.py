...
from handlers.chats import get_all_chats_handlers, set_chat_listener_handlers, quit_chat, send_message_to_chat, \
    start_dialog
...
def get_app():
    ...
    set_chat_listener_handler = CommandHandler('listen_chat', set_chat_listener_handlers)
    start_dialog_handler = CommandHandler('start_dialog', start_dialog)
    quit_chat_handler = CommandHandler('quit', quit_chat)
    send_chat_message_handler = ConversationHandler(
    ...
    application.add_handler(send_chat_message_handler)
