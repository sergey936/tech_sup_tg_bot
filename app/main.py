...
from handlers.chats import get_all_chats_handlers, set_chat_listener_handlers
...
def get_app():
    ...
    set_chat_listener_handler = CommandHandler('set_chat', set_chat_listener_handlers)
